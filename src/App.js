...
function App() {
  const stripePromise = loadStripe(
    "pk_test_51OxkzZRrXTmqgdeVjd9zhKd5RgQ7FeiR5dmb2HoiH3zFCHGpKPCHHOui9VPGjjPF04OunDRn392nie85S1CDqw74008hYbyjua"
    );
  ...
  const router = createBrowserRouter(
    ...
    createRoutesFromElements(
      //defines a Route component that matchs all path "/" andrenders the Main component.
  ...
  return (
    <div className="App">
      {/* This ensures that the rounting functionality is available throughoutt the application */}
