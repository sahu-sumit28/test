...
const FilterModal = ({ selectedFilters, onFilterChange, onClose }) => {
    ...
    const [propertyType, setPropertyType] = useState(
        selectedFilters.propertyType || "" //by default it is empty or the selected propertyt type from props
    );
    ...
    //functions to Handle changes inPrice Range
    ...
    //value send in backend
    //label displaying on frontend
    //icon is in small letter
    ...
    //function to hnadle changes in propertyType
